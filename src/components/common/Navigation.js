...
const Navigation = () => {
  ...
  return (
      <header className={`fixed left-0 right-0 z-50 ${menuTopShow}  transition-all duration-600 ease-in-out dark:bg-[--bg-dark-theme-color] bg-white`}>
      <nav className="flex justify-between items-center px-3 lg:px-10 py-5 shadow-sm dark:shadow-[#334155] relative">
          ...
          <ul className={`flex flex-col mr-4 h-[calc(100vh-68.35px)] font-bold  absolute top-[68.35px] dark:bg-[--bg-dark-theme-color] bg-white lg:flex-row lg:static lg:items-center lg:h-full ${menuActiveStr} transition-all duration-300 ease-in-out`}>
